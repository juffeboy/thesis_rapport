...
There are several reasons why to use an ICN approach in the IoT domain. Everything is always depending on application and usage, but here are some pros and cons using ICN in the IoT domain.
