...
%\end{itemize}
By 2020 a total of 26 billion IoT units is estimated to be installed world wide. It represents a staggering 30 time increase from the year of 2009, where a total of 0.9 billion units was installed \cite{Gartner}. \todo{Big jump in context here from IoT overall to communication. Try to bridge that with one more sentense.} The increase in demand for IoT-related equipment and services has led to several major manufacturers joining the market, which in turn led to several different communcation standards which the IoT devices communicates with being developed. 
