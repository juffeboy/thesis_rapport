...
\begin{itemize}
	...
	\item Result-section
	\\Section 4, latency performance evaluation, presents result regarding the latency performance evaluation. A 

	\item Feasibility
	\\Section 5, suitibility, presents the results on how well the algorithm performs that follows the data periodicity at the sensor. 
	%\item Discussion-section, conclusion/futurework-section
	\\In section 6 the results from the previous two sections are analyzed and discussed in order to reach the conclusion presented in section 7.
\end{itemize}
